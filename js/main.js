...
//     o[i] = o[i] + 1 / num;
//     twoD.fillStyle = 'hsla(' + i + 2 + ', 90%, 50%,' + o[i] + ')';
//     twoD.beginPath();
//     twoD.setTransform(Math.cos(num * i),
//       Math.sin(num * rad),
//       Math.sin(num * i),
//       Math.cos(num * rad),
//       c.width / 2, c.height);
//     if (i != 0)
//       twoD.fillRect(num * 6 * o[i - 1], 0, c.width, c.height);
//     else
//       twoD.fillRect(num * 6 * _o, 0, c.width, c.height);
//     twoD.fill();
//   }
